<h2><a href="https://leetcode.com/problems/minimum-cost-to-move-chips-to-the-same-position/description/?envType=problem-list-v2&envId=greedy">1329. Minimum Cost to Move Chips to The Same Position</a></h2><h3>Easy</h3><hr><p>We have <code>n</code> chips, where the position of the <code>i<sup>th</sup></code> chip is <code>position[i]</code>.</p>
